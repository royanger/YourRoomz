...
const Privacy = () => {
  return (
    <div className="privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to YourRoomz.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to YourRoomz, accessible from{' '}
            <a
              href="https://yourroomz.com/"
      ...
      <ul>
        <li>By email: pat.quinn@yourroomz.com</li>
      </ul>
    </div>
  )
}
